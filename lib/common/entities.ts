...
export class Person {
    ...
    public static fromFile(path: string, encoding: string = "utf8"): Person[] {
...
export class Group implements IRepositoryInfo {
    ...
    public static get headers(): String[] {
        return Person.headers.concat("group");
    }
...
export class Student extends Person implements IRepositoryInfo {
    ...
    public static fromFile(path: string, organization: string, encoding: string = "utf8"): Student[] {
